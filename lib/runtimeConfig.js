...
function resolveRuntimeConfig(overrides = {}) {
  return {
    ...
    defaultExtractModel:
      overrides.defaultExtractModel
      || process.env.GPT_IMAGE_EXTRACT_MODEL
      || process.env.GPT_IMAGE_REVIEW_MODEL
      || 'gpt-4o',
    ...
    extractEnabled: parseBooleanFlag(
      overrides.extractEnabled,
      parseBooleanFlag(process.env.GPT_IMAGE_EXTRACT_ENABLED, true),
    ),
