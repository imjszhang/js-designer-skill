...
const referencePaths = {
  ...
  aipochInvestorDeck: {
    dir: path.join(referencesRoot, 'aipoch-investor-deck'),
    readme: path.join(referencesRoot, 'aipoch-investor-deck', 'README.md'),
    design: path.join(referencesRoot, 'aipoch-investor-deck', 'design.md'),
    audit: path.join(referencesRoot, 'aipoch-investor-deck', 'audit-r5-r6.md'),
    illustrationStyle: path.join(
      referencesRoot,
      'aipoch-investor-deck',
      'illustration-style.md',
    ),
    slideTypes: path.join(referencesRoot, 'aipoch-investor-deck', 'slide-types.md'),
    assetsDir: path.join(referencesRoot, 'aipoch-investor-deck', 'assets'),
    assetsReadme: path.join(referencesRoot, 'aipoch-investor-deck', 'assets', 'README.md'),
    illustrationReferencesDir: path.join(
      referencesRoot,
      'aipoch-investor-deck',
      'assets',
